    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between text-sm text-muted-foreground">
        ...
        <div className="flex gap-1.5">
          ...
          {question?.difficulty === "easy" && <Badge variant="outline" className="rounded-full border-green-400 px-3 text-xs font-normal text-green-700 dark:text-green-400">簡單</Badge>}
          {question?.difficulty === "medium" && <Badge variant="outline" className="rounded-full bg-yellow-100 px-3 text-xs font-normal text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-300">中等</Badge>}
          {question?.difficulty === "hard" && <Badge variant="destructive" className="rounded-full px-3 text-xs font-normal">困難</Badge>}
        </div>
      </div>
      ...
      <Card className="shadow-sm">
        <CardContent className="space-y-4 p-5">
          ...
          {question.hint && !state.isAnswerChecked ? (
